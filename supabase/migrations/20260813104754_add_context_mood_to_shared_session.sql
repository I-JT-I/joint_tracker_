...
begin
  ...
  loop
    ...
    insert into public.smokes (
      ...
      -- il tag di contesto/umore e' soggettivo: si applica solo a chi crea la sessione,
      -- MAI copiato agli altri partecipanti (stesso errore gia' corretto per my_fumo_grams)
